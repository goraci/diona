...
set :scm, :git
set :repository,  "/home/bob/proj/diona"

set :user, "hosting_fell-v"
set :use_sudo, false
set :deploy_to, "/home/hosting_fell-v/projects/diona"
...
set :unicorn_conf, "/etc/unicorn/diona.fell-v.rb"
set :unicorn_pid, "/var/run/unicorn/diona.fell-v.pid"
